...
| 75 | Construction | Reliability only — inspect, fasten, strain-relieve, pack |
| 25 | Integration | Config check; TRACE quotas; AMPER passive; BEACON no intervention; rollback drill |
| 10 | Closeout | TRACE evidence, explain-back, dashboard freeze note, cleanup |
