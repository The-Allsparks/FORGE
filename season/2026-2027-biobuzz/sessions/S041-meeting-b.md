...
| Session ID | S041 |
| Title | Meeting B — final reps |
| Calendar date | 2027-02-12 (planning input; 4:00–6:00 PM unless Kickoff/event) |
| Meeting type | B |
...
- Documented progress on the focus named in `calendar.yaml` `title` for S041
- No new active features without evidence

## Prerequisites

- [calendar.yaml](../calendar.yaml) row for S041
...
**Filename is fixed:** `S041-meeting-b.md`. Edit `title` in this file and `calendar.yaml` when the week's topic changes.
