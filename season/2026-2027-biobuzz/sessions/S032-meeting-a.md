---
id: S032
title: "Meeting A — pre-tournament build"
date: 2027-01-11
meeting_type: A
...
# S032 — Meeting A — pre-tournament build
...
| Session ID | S032 |
| Title | Meeting A — pre-tournament build |
| Calendar date | 2027-01-11 (planning input; 4:00–6:00 PM unless Kickoff/event) |
| Meeting type | A |
...
- Documented progress on the focus named in `calendar.yaml` `title` for S032
- No new active features without evidence

## Prerequisites

- [calendar.yaml](../calendar.yaml) row for S032
...
**Filename is fixed:** `S032-meeting-a.md`. Edit `title` in this file and `calendar.yaml` when the week's topic changes.
