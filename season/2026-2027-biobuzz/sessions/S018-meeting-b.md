...
# S018 — Meeting B — driver and auto reps
...
- [calendar.yaml](../calendar.yaml) row for S018
...
**Filename is fixed:** `S018-meeting-b.md`. Edit `title` in this file and `calendar.yaml` when the week's topic changes.
