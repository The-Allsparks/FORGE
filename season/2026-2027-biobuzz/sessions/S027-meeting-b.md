...
# S027 — Meeting B — driver and auto reps
...
- [calendar.yaml](../calendar.yaml) row for S027
...
**Filename is fixed:** `S027-meeting-b.md`. Edit `title` in this file and `calendar.yaml` when the week's topic changes.
