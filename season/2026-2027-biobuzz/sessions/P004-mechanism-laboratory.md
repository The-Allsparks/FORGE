...
# P004 — Reusable mechanism laboratory
...
- S002 baseline **or** documented chassis blocker (experiments still run off-robot)
...
| 10 | Closeout | Explain-back; store reusable parts; prep P005 summary |
...
- P005: summarize experiments; Kickoff role assignments
...
Same as fallback. Strafer not required for P004.
