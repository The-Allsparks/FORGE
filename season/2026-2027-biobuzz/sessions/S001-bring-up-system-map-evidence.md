...
# S001 — Bring-up, system map, and evidence
...
If the chassis was built in P001–P003, can we prove—one motor at a time—that measurement, decision, command, and result match reality?
...
- [P001](P001-chassis-sponsor-cards.md)–[P003](P003-electrical-foundation.md) complete: chassis, rolling drivetrain, wired power path
...
- No floor driving today — that is S002

## Required hardware

- P002–P003 drivetrain and wiring
- Blocks, crate, or stand; safety glasses
- Control Hub, battery, main switch per P003 layout
...
- Charge batteries; print P003 power-path sketch
...
| ---: | --- | --- |
| 10 | Opening | Safety: elevated test only; software cap; goals; review P003 wiring list |
...
| 10 | Closeout | Explain-back measurement→result chain; dashboard note; assign S002 prep |
...
4. What did P003 leave for today to verify?
...
- S002: full mecanum baseline on restraint/carpet if S001 complete
...
- [P002 modified drivetrain](P002-modified-drivetrain-install.md)
- [P003 electrical foundation](P003-electrical-foundation.md)

## Mentor notes

**Not** first assembly — P001–P003 already built the chassis. Protect bring-up from becoming a 75-minute Gradle session; cap software at 30 minutes. Drivetrain must be serviceable after today.
