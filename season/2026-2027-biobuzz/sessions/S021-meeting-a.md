...
# S021 — Meeting A — mechanism of the week
...
- [calendar.yaml](../calendar.yaml) row for S021
...
**Filename is fixed:** `S021-meeting-a.md`. Edit `title` in this file and `calendar.yaml` when the week's topic changes.
