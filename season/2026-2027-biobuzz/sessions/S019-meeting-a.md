...
# S019 — Meeting A — mechanism of the week
...
- [calendar.yaml](../calendar.yaml) row for S019
...
**Filename is fixed:** `S019-meeting-a.md`. Edit `title` in this file and `calendar.yaml` when the week's topic changes.
