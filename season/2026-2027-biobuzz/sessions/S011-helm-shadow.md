...
# S011 — HELM shadow recommendations
...
Bring the S010 tree. One laptop with HELM tests if time. Printed disable: mode `OFF`; run Pedro auto.

## Exact 120-minute agenda

| Duration (min) | Block | Activity |
| ---: | --- | --- |
| 10 | Opening | Shadow mode is observe-only; review auto logs and test goal |
| 75 | Construction | Reliability repairs; shadow recording if observe-only path exists |
| 25 | Integration | Compare shadow recommendations to human strategy — no execute |
| 10 | Closeout | Inspection, log review, explain-back, cleanup |
...
S012 league prep. Unnumbered days: drive.

## Hardware-unavailable fallback

Paper autos walked. Diff table from a walked route vs the S010 tree.
