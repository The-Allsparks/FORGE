...
# S002 — BEACON communications freshness and recovery
...
| ---: | --- | --- |
| 10 | Opening | Review S001 tape-vs-vision note; test goal: **drive reps + classify a stale stick**; safety: official stop only |
...
| Path | Work |
| ---- | ---- |
| Mechanical | Repair anything that failed S001/S002 inspection |
