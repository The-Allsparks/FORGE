...
| **BumbleBee** (competition one) | Modular competition robot | Post-G3 fabrication through events |
| **Official starter-bot design** | Scoring baseline and **fallback** | G2 comparison; G3/G5 fallback if custom slips |
| **Bench / fixture rigs** | Mechanism development without blocking BumbleBee | G2 exploration; Version 2 after G7 |

## Shared parts inventory

Maintain a table in the engineering notebook (updated at G3 and G4):

| Part / assembly | Strafer | BumbleBee | Fixture | Notes |
| --------------- | ------- | ------- | ------- | ----- |
| Mecanum wheel set | | | | |
...
**Rule:** The same physical component cannot be planned in two places simultaneously. If Strafer donates a part to BumbleBee, update Strafer status to `non-driving` until replaced.

## Software implications

- Preseason Pedro tuning on Strafer **does not** transfer unchanged to BumbleBee mass and geometry — retune at G6 on BumbleBee.
...
After BumbleBee reaches G7 mechanical/software freeze:
...
1. Install official starter-bot scoring assembly on BumbleBee drivetrain.
