...
UPDATES = {
    ...
    "S005": {
        ...
        "dq": "What modular BumbleBee architecture fits our evidence — and what are we explicitly cutting?",
    ...
    "S007": {
        ...
        "obj": "Students fabricate authorized BumbleBee modules; deliver first modules to programming pair; declare G4 design freeze on module set.",
    ...
    "S008": {
        ...
        "dq": "Is BumbleBee mechanically and electrically complete enough for clinic data collection?",
    ...
    "S009": {
        ...
        "dq": "What did clinic prove — and is BumbleBee stable enough for sustained software and driver work?",
        "obj": "Students run [event-retrospective.md](../../../templates/event-retrospective.md) for clinic; begin G6 handoff: minimum teleop stable, Pedro tuning on BumbleBee mass (not Strafer assumptions).",
    ...
    "S010": {
        ...
        "obj": "Students build minimum reliable Pedro (or conventional) auto on BumbleBee; tune mechanisms; stop major mechanical changes.",
